  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white px-20 py-12 mx-auto">
        <h1 className="text-4xl font-bold text-amber-400 mb-6 text-center">Terms & Conditions</h1>
        <p className="text-gray-300 mb-4 text-sm text-center">Last updated on 20-07-2025 00:53:22</p>

        <p className="text-gray-300 mb-4 text-lg">
          These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
          agreement by and between KANCHAN SHUKLA, ( “Website Owner” or “we” or “us” or “our”) and you
        ...
        <h2 className="text-white font-semibold text-xl mb-2 mt-6">The use of this website or availing of our Services is subject to the following terms of use:</h2>
        <ul className="list-disc list-inside text-gray-400 space-y-2">
          ...
          <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive
            jurisdiction of the courts in Bareilly, UTTAR PRADESH
            .</li>
