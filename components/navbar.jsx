        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <Input type="text" placeholder="Search for pets, food, toys..." className="pl-10 pr-4 w-full" />
            </div>
          </div>

          {/* Right Side Icons */}
          <div className="flex items-center space-x-4">
            {!isAdmin && <><div onClick={() => { router.push('/wishlist') }}><Button variant="ghost" size="icon" className="hover:cursor-pointer hidden md:flex">
              <Heart className="w-5 h-5" />
            </Button></div>

              <Link href='/cart'><Button variant="ghost" size="icon" className="hover:cursor-pointer relative">
